...
<nav class="navbar navbar-expand-lg navbar-light sticky-top" style="width: 100%; background-color:#0866FF;">
  ...
  <main style="display: flex; flex-direction: column; min-height: 15vh;">
    ...
    <a href="{{ route('player-home') }}" type="button" class="btn btn-secondary " style="margin-top: 10px;  margin-right: 10px;">Tournament</a>
        <a href="{{ route('team-view') }}" type="button" class="btn btn-secondary disabled" style="margin-top: 10px;">Team</a>
      ...
      <div class="d-flex justify-content-center">
          <h3 class="text-center">{{ $teammanager->team_name }}'s Registered Tournaments</h3>
        </div>
        <div class="d-flex justify-content-center">
          <div class="alert alert-warning text-center p-1" style="margin-top: 10px;" role="alert">
            Your join team request has been approved.
          </div>
        </div>
                  ...
                  <div class="card" style="width: 18rem;">
                    <div class="card-body text-center">
                      ...
                      <div class="dropdown d-flex justify-content-end mt-3">
                        <a class="dropdown-item" href="{{ route('player-match', $tournament->id) }}">
                          View
                        </a>
                      </div>
                    </div>
