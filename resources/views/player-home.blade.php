...
<nav class="navbar navbar-expand-lg navbar-light sticky-top" style="width: 100%; background-color:#0866FF;">
  ...
  <main style="display: flex; flex-direction: column; min-height: 15vh;">
    <div class="container-expand-lg px-0" style="display: flex; justify-content: center;">
        ...
        <a href="{{ route('player-home') }}" type="button" class="btn btn-secondary disabled" style="margin-top: 10px;  margin-right: 10px;">Tournament</a>
        <a href="{{ route('team-view') }}" type="button" class="btn btn-secondary" style="margin-top: 10px;">Team</a>
          ...
          <div class="col-md-4 d-flex justify-content-center mb-4">
            <div class="card" style="width: 18rem;">
              <div class="card-body text-center">
                ...
                <a class="dropdown-item" href="{{ route('player-match', $tournament->id) }}">View</a>
              </div>
            </div>
          </div>
        @endforeach
