                ...
                <div class="card shadow-lg">
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <p class="form-control-plaintext">{{ $player->fullname }}</p>
                        </div>
                        <div class="mb-3">
                            <label for="email" class="form-label"><strong>Email:</strong></label>
                            <p class="form-control-plaintext">{{ $player->email }}</p>
                        </div>
                        <div class="mb-3">
                            <label for="phone_number" class="form-label"><strong>Phone Number:</strong></label>
                            <p class="form-control-plaintext">{{ $player->phone_number }}</p>
                        </div>
                        <div class="text-center mt-4">
                            <a href="{{ route('player-updateprof') }}" class="btn btn-primary">Update Account</a>
                        </div>
                    </div>
                </div>
    </div>
