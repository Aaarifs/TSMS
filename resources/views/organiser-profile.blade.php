          ...
          <img src="../image/logo (7).png" alt="Login Page Image" class="img-fluid" style="width: 192px; height: 98px;">
                ...
                <div class="card shadow-lg">
                    <div class="card-header" style="width: 100%; background-color:#0866FF; position: relative;">
                        <a href="{{ route('organiser-home') }}" class="btn btn-link position-absolute text-white" style="text-decoration: none; left: 10px;">&lt; Back</a>
                        <h3 class="text-white text-center">Account Details</h3>
                    </div>
                    <div class="card-body">
                        <div class="mb-3">
                            <label for="full_name" class="form-label"><strong>Full Name:</strong></label>
                            <p class="form-control-plaintext">{{ $organiser->fullname }}</p>
                        </div>
                        <div class="mb-3">
                            <label for="email" class="form-label"><strong>Email:</strong></label>
                            <p class="form-control-plaintext">{{ $organiser->email }}</p>
                        </div>
                        <div class="mb-3">
                            <label for="phone_number" class="form-label"><strong>Phone Number:</strong></label>
                            <p class="form-control-plaintext">{{ $organiser->phone_number }}</p>
                        </div>
                        <div class="text-center mt-4">
                            <a href="{{ route('organiser-updateprof') }}" class="btn btn-primary">Update Account</a>
                        </div>
                    </div>
                </div>
    </div>
