...
<nav class="navbar navbar-expand-lg navbar-light sticky-top" style="width: 100%; background-color:#0866FF;">
  ...
  <div class="container-expand-lg px-0" style="display: flex; justify-content: center;">
        ...
        <a href="home-upcoming.html" type="button" class="btn btn-secondary disabled" style="margin-top: 10px; margin-right: 10px;">Tournament</a>
    </div>
    ...
    <div class="container">
        <div class="container-expand-lg px-0" style="display: flex; justify-content: center;">
        <a href="{{ route('player-tournaments', ['type' => 'upcoming']) }}" class="btn btn-primary {{ $type === 'upcoming' ? 'active' : '' }}">Upcoming</a>
<a href="{{ route('player-tournaments', ['type' => 'past']) }}" class="btn btn-primary {{ $type === 'past' ? 'active' : '' }}">Past</a>
        </div>
    </div>
