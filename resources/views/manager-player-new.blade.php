...
<nav class="navbar navbar-expand-lg navbar-light sticky-top" style="width: 100%; background-color:#0866FF;">
  ...
  <main style="display: flex; flex-direction: column; min-height: 15vh;">
    <div class="container-expand-lg px-0" style="display: flex; justify-content: center;">
      <a href="home-upcoming.html" type="button" class="btn btn-primary disabled" style="margin-top: 10px; margin-right: 10px;">Players</a>
      <a href="home-upcoming.html" type="button" class="btn btn-primary" style="margin-top: 10px; margin-right: 10px;">Tournament</a>
        ...
        <div class="col-md-8">
          <div class="card">
            <div class="card-header" style="width: 100%; background-color:#0866FF;">
              <a href="{{ route('manager-player') }}" class="btn btn-link position-absolute text-white" style="left: 10px; text-decoration: none;">&lt; Back</a>
                ...
                <tbody>
                  @foreach ($requests as $request)
                    <tr class="text-center">
                      ...
                      <td>
                        <form action="{{ route('approve-request', $request->id) }}" method="post" style="display:inline-block;">
                          @csrf
                          <button type="submit" class="btn btn-success">Approve</button>
                        </form>
                        <form action="{{ route('decline-request', $request->id) }}" method="post" style="display:inline-block;">
                          @csrf
