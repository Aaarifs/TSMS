...
<head>
  ...
  <title>TSMS - Past Tournaments</title>
...
<main style="display: flex; flex-direction: column; min-height: 15vh;">
  <div class="container-expand-lg px-0" style="display: flex; justify-content: center;">
      <a href="home-upcoming.html" type="button" class="btn btn-primary" style="margin-top: 10px; margin-right: 10px;">Players</a>
      <a href="home-upcoming.html" type="button" class="btn btn-primary disabled" style="margin-top: 10px; margin-right: 10px;">Tournament</a>
  ...
  <div class="container">
    <div class="container-expand-lg px-0" style="display: flex; justify-content: center;">
    <a href="{{ route('manager-home')}}" type="button" class="btn btn-primary " style="margin-right: 10px;">Upcoming</a>
    <a href="{{ route('show-tournaments', ['type' => 'past']) }}" type="button" class="btn btn-primary disabled ">Past</a>
    </div>
</div>
  <div class="container mt-3">
    <div class="row justify-content-center">
      @if($tournaments->isEmpty())
          <p class="text-center">No past tournaments available.</p>
      @else
